...
function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Update the error message based on the error code
      switch (error.code) {
...
const Container = styled.div`
  ...
  .content {
    ...
    .form-container {
      ...
      .form {
        ...
        max-width: 25rem; /* Added max-width for larger screens */
        gap: 2rem;
        color: white;
        .title {
  ...
  @media (min-width: 768px) {
    .form-container {
      .form {
        max-width: 40rem; /* Adjusted max-width for larger screens */
      }
    }
  }
`;
